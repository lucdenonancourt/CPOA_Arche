...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Inscription_t, stringdata) + ofs \
...
QT_MOC_LITERAL(2, 34, 0)
    ...
    "Inscription\0on_buttonBox_accepted\0\0"
};
...
void Inscription::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Inscription *_t = static_cast<Inscription *>(_o);
        switch (_id) {
...
const QMetaObject Inscription::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Inscription.data,
      qt_meta_data_Inscription,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Inscription.stringdata))
        return static_cast<void*>(const_cast< Inscription*>(this));
